...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-indigo-600 to-purple-400 text-white px-6 py-12 ">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        {/* Brand Info */}
        <div>
          <h2 className="text-2xl font-bold mb-3">VendorVerse</h2>
      ...
      {/* Bottom Line */}
      <div className="mt-12 text-center text-sm text-white border-t border-gray-700 pt-6">
        &copy; {new Date().getFullYear()} VendorVerse. All rights reserved. <br />
        Developed with ❤️ by <span className="font-semibold">Vinay Kumar</span>
      </div>
