...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen px-4 sm:px-6 md:px-12 py-24 bg-white text-gray-800">
      <div className="max-w-5xl mx-auto bg-white border border-gray-200 rounded-2xl shadow-2xl p-8 sm:p-12">
...
function Section({ title, children }) {
  return (
    <section className="bg-gray-50 border border-gray-200 rounded-xl p-5 sm:p-6 shadow-sm">
      <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">{title}</h2>
